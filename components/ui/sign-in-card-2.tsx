...
export function SignInCard({ onSignIn, onGuestLogin, error: externalError }: SignInCardProps) {
          ...
          <div className="relative group">
            ...
            />
              ...
              <div className="absolute -inset-[1px] rounded-2xl overflow-hidden">
                ...
                <motion.div 
                  className="absolute top-0 left-0 h-[5px] w-[5px] rounded-full bg-cyan-300/40 blur-[1px]"
                  animate={{ opacity: [0.2, 0.4, 0.2] }}
                  transition={{ duration: 2, repeat: Infinity, repeatType: "mirror" }}
                />
                <motion.div 
                  className="absolute top-0 right-0 h-[8px] w-[8px] rounded-full bg-cyan-300/60 blur-[2px]"
                  animate={{ opacity: [0.2, 0.4, 0.2] }}
                  transition={{ duration: 2.4, repeat: Infinity, repeatType: "mirror", delay: 0.5 }}
                />
                <motion.div 
                  className="absolute bottom-0 right-0 h-[8px] w-[8px] rounded-full bg-cyan-300/60 blur-[2px]"
                  animate={{ opacity: [0.2, 0.4, 0.2] }}
                  transition={{ duration: 2.2, repeat: Infinity, repeatType: "mirror", delay: 1 }}
                />
                <motion.div 
                  className="absolute bottom-0 left-0 h-[5px] w-[5px] rounded-full bg-cyan-300/40 blur-[1px]"
                  animate={{ opacity: [0.2, 0.4, 0.2] }}
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/[0.05] bg-black/40 p-5 shadow-2xl backdrop-blur-xl sm:p-6">
                ...
                <div className="text-center space-y-1 mb-5">
                  ...
                  >
                    Sign in to continue to BurryAI
                  </motion.p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-1">
                    <div className="flex items-center space-x-2">
                      <div className="relative">
                        <input
                          ...
                          className="appearance-none h-4 w-4 rounded border border-white/20 bg-white/5 checked:bg-cyan-400 checked:border-cyan-400 focus:outline-none focus:ring-1 focus:ring-cyan-300/30 transition-all duration-200"
                        />
                        {rememberMe && (
                          <motion.div 
                    ...
                    <div className="text-xs relative group/link">
                      <Link href="#" className="text-white/60 hover:text-cyan-300 transition-colors duration-200">
                        Forgot password?
                      </Link>
                    </div>
                  </div>
                  ...
                  >
                    <div className="absolute inset-0 bg-cyan-400/5 rounded-lg blur opacity-0 group-hover/guest:opacity-70 transition-opacity duration-300" />
                    
                    <div className="relative overflow-hidden bg-white/5 text-white font-medium h-10 rounded-lg border border-cyan-500/15 hover:border-cyan-400/30 transition-all duration-300 flex items-center justify-center gap-2">
                      <UserCircle2 className="w-4 h-4 text-cyan-300/80 group-hover/guest:text-cyan-300 transition-colors duration-300" />
                ...
                >
                  ...
                  >
                    <span className="relative z-10 text-cyan-300 group-hover/signup:text-cyan-200 transition-colors duration-300 font-medium">
                      Sign up
                    </span>
                    <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-cyan-300 group-hover/signup:w-full transition-all duration-300" />
                  </Link>
                </motion.p>
              </form>
            </div>

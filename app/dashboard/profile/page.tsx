...
import { Monitor, Moon, Palette, Plus, Sun, Trash2, UserRound, WalletCards } from 'lucide-react'
...
export default function DashboardProfilePage() {
  ...
  return (
    <div>
      ...
      <div className="rounded-xl border border-slate-200/80 bg-white/95 p-4 shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:border-cyan-500/20 dark:bg-black/20 dark:shadow-none sm:p-6">
        {isGuest ? (
          <div className="mb-4 rounded-lg border border-amber-400/40 bg-amber-500/10 px-4 py-3 text-sm text-amber-900 dark:text-amber-100">
            Guest mode cannot persist profile updates. Sign up to save profile data.
          </div>
        ) : null}

        {error ? (
          <div className="mb-4 rounded-lg border border-rose-500/40 bg-rose-500/10 px-4 py-3 text-sm text-rose-700 dark:text-rose-200">{error}</div>
        ) : null}

        {success ? (
          <div className="mb-4 rounded-lg border border-emerald-500/40 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-800 dark:text-emerald-100">{success}</div>
        ) : null}

        <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
          <div>
            <h3 className="flex items-center gap-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">
              <UserRound className="h-6 w-6 text-cyan-600 dark:text-cyan-300" />
              Profile Settings
            </h3>
          ...
          <Button
            ...
            className="w-full border-slate-200 bg-white text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-200 dark:hover:bg-slate-800 sm:w-auto"
          >
            Re-run onboarding
          </Button>
        </div>
        ...
        <div className="mb-6 rounded-xl border border-slate-200 bg-slate-50/60 p-5 dark:border-slate-700/60 dark:bg-slate-950/50">
          <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
            <div>
              <h4 className="flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.2em] text-cyan-600 dark:text-cyan-200/90">
                <Palette className="h-4 w-4 text-cyan-500 dark:text-cyan-300" />
                Appearance & Theme
              </h4>
              <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                Choose your preferred interface theme across Burry AI.
              </p>
            </div>
            <div className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white p-1 dark:border-slate-800 dark:bg-slate-900/80">
              <button
                type="button"
                ...
                className={cn(
                  ...
                  theme === 'light'
                    ? 'bg-cyan-500 text-white shadow-sm dark:bg-cyan-400 dark:text-slate-950'
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="space-y-4 rounded-xl border border-slate-200 bg-slate-50/60 p-5 dark:border-slate-700/60 dark:bg-slate-950/50">
            <h4 className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-600 dark:text-cyan-200/90">Personal & Academic</h4>
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus-visible:ring-cyan-500 dark:border-cyan-500/30 dark:bg-slate-950/70 dark:text-slate-100 dark:placeholder:text-slate-500"
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="student_status" className="text-slate-700 dark:text-slate-300">Student status</Label>
                <Input
                  id="student_status"
          ...
          <div className="space-y-4 rounded-xl border border-slate-200 bg-slate-50/60 p-5 dark:border-slate-700/60 dark:bg-slate-950/50">
            <h4 className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-600 dark:text-cyan-200/90">Financial Preferences</h4>
            <div className="space-y-3">
              <div className="space-y-2">
                <Label htmlFor="monthly_income" className="text-slate-700 dark:text-slate-300">Monthly income</Label>
                <Input
                  id="monthly_income"
                  type="number"
                  min={0}
              ...
              <div className="space-y-2">
                <Label htmlFor="savings_goal" className="text-slate-700 dark:text-slate-300">Savings goal</Label>
                <Input
                  id="savings_goal"
                  type="number"
                  min={0}
              ...
              <div className="space-y-2">
                <Label htmlFor="risk_tolerance" className="text-slate-700 dark:text-slate-300">Risk tolerance</Label>
                <select
                  id="risk_tolerance"
                  ...
                  className="h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none focus:border-cyan-500 dark:border-cyan-500/30 dark:bg-slate-950/70 dark:text-slate-100 dark:focus:border-cyan-300"
                >
          ...
          <div className="space-y-4 rounded-xl border border-slate-200 bg-slate-50/60 p-5 dark:border-slate-700/60 dark:bg-slate-950/50 lg:col-span-2">
            <h4 className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-600 dark:text-cyan-200/90">Income Opportunities Profile</h4>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="profession" className="text-slate-700 dark:text-slate-300">Profession / target role</Label>
                <Input
                  id="profession"
              ...
              <div className="space-y-2">
                <Label htmlFor="preferred_work_mode" className="text-slate-700 dark:text-slate-300">Preferred mode</Label>
                <select
              ...
              <div className="space-y-2 md:col-span-2">
                <Label htmlFor="skills_csv" className="text-slate-700 dark:text-slate-300">Skills (comma separated)</Label>
                <Input
                  id="skills_csv"
              ...
              <div className="space-y-2 md:col-span-2">
                <Label htmlFor="other_talents_csv" className="text-slate-700 dark:text-slate-300">Other talents (comma separated)</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="state_region" className="text-slate-700 dark:text-slate-300">State / region</Label>
                <Input
                  id="state_region"
              ...
              <div className="space-y-2">
                <Label htmlFor="remote_regions_csv" className="text-slate-700 dark:text-slate-300">Remote regions (comma separated)</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="opportunity_radius_km" className="text-slate-700 dark:text-slate-300">Nearby radius (km)</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="min_hourly_rate" className="text-slate-700 dark:text-slate-300">Minimum hourly rate</Label>
                <Input
                  id="min_hourly_rate"
                  type="number"
                  min={0}
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="space-y-4 rounded-xl border border-slate-200 bg-slate-50/60 p-5 dark:border-slate-700/60 dark:bg-slate-950/50">
            <div className="flex items-start justify-between gap-3">
              <div>
                <h4 className="flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.2em] text-cyan-600 dark:text-cyan-200/90">
                  <WalletCards className="h-4 w-4 text-cyan-500 dark:text-cyan-300" />
            ...
            <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-slate-700 dark:text-slate-300">
              Saved categories: <span className="font-semibold text-slate-900 dark:text-white">{normalizedSpendingRows.length}</span>
              {' '}| Monthly total: <span className="font-semibold text-slate-900 dark:text-white">${spendingSetupTotal.toFixed(2)}</span>
            </div>
            ...
            <div className="space-y-3">
              {spendingRows.map((row, index) => (
                <div key={row.id} className="grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_180px_44px]">
                  <div className="space-y-2">
                    <Label htmlFor={`spending-category-${row.id}`} className="text-slate-700 dark:text-slate-300">Category {index + 1}</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`spending-amount-${row.id}`} className="text-slate-700 dark:text-slate-300">Monthly amount</Label>
                    <Input
                  ...
                  <div className="flex items-end">
                    <Button
                      ...
                      className="w-full border-slate-200 bg-white text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-200 dark:hover:bg-slate-800"
          ...
          <div className="space-y-3 rounded-xl border border-slate-200 bg-slate-50/60 p-5 dark:border-slate-700/60 dark:bg-slate-950/50">
            <h4 className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-600 dark:text-cyan-200/90">Quick Add Loan</h4>
            ...
            <Button
              ...
              disabled={isGuest}
              className="rounded-xl border border-cyan-400/60 bg-cyan-400 px-4 py-2.5 font-semibold text-slate-950 shadow-[0_10px_30px_rgba(34,211,238,0.25)] hover:bg-cyan-300"
            >
              Add loan
            </Button>

            <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800/70 dark:bg-slate-900/60">
              <div className="flex items-center justify-between gap-3">
                <h5 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Saved loans</h5>
                <span className="text-xs text-slate-500 dark:text-slate-400">{loans.length} total</span>
              </div>
              ...
              <div className="mt-3 space-y-3">
                {loans.length === 0 ? (
                  ...
                  loans.map((loan) => (
                    <div key={loan.id} className="rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-800/80 dark:bg-slate-950/70">
                      <div className="flex items-start justify-between gap-3">
                        <div className="space-y-1">
                          <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{loan.loan_name}</p>
                        ...
                        <Button
                          ...
                          className="border-slate-200 bg-white text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-200 dark:hover:bg-slate-800"
        ...
        <div className="mt-7 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
          <Button
            ...
            className="w-full rounded-xl border border-cyan-400/60 bg-cyan-400 px-4 py-2.5 font-semibold text-slate-950 shadow-[0_10px_30px_rgba(34,211,238,0.25)] hover:bg-cyan-300 sm:w-auto"
          >
